...
public class RestUserController {
  ...
  /*@RequestMapping(value = {"/", "/users"}, method = { RequestMethod.GET, RequestMethod.POST, RequestMethod.OPTIONS } )
  public List<User> index(@RequestParam(required = false) String name) {
    ...
    @RequestMapping(value = {"/", "/customers"}, method = { RequestMethod.GET, RequestMethod.POST, RequestMethod.OPTIONS } )
